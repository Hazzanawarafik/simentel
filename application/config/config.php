...
|
*/
$config['encryption_key'] = '@ddcdb14cdf*e87fe$a15a6^c2f*877%598aa';
...
$config['sess_cookie_name'] = 'XIShKFql';
...
$config['csrf_token_name'] = 'FGsdXjpM';
$config['csrf_cookie_name'] = 'ZCkmQonW';
