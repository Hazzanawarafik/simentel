	...
	<div class="login-box">
		...
		'method'  => 'POST'
			...
			<div class="form-group has-feedback <?= form_error('email') ? 'has-error' : ''; ?>">
				...
				<div class="row">
					<div class="col-md-12 captcha-image">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="input-group">
							<input type="text" name="captcha" class="form-control" placeholder="Masukkan kode captcha disini">
							<div class="input-group-btn captcha-refresh" data-captcha-time="<?= $cap['time']; ?>">
								<!-- <a class="btn btn-danger refresh-captcha"><i class="fa fa-refresh"></i></a> -->
								<button type="button" class="btn btn-danger refresh-captcha" title="Refresh kode captcha"><i class="fa fa-refresh"></i></button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12">
					<div class="checkbox icheck">
						<label>
							...
							<?= cclang('i_agree_to_the_terms'); ?> <a href="javascript:void();" data-toggle="modal" data-target="#modal-default">Term & Conditions</a>
						</label>
					</div>
				</div>
			</div>
