...
class Model_pemohon extends MY_Model {
    ...
    public $field_search   = ['pemohon_nama', 'pemohon_jenkel', 'pemohon_alamat', 'kecamatan_id', 'kelurahan_id', 'agama_id', 'pemohon_kode', 'kecamatan.kecamatan_nama', 'kelurahan.kelurahan_nama', 'agama.agama_nama'];
