					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-horizontal form-step" name="form_pemohon" id="form_pemohon">
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_id"><?= _ent($pemohon->pemohon_id)._ent($pemohon->pemohon_kode); ?></span>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_id"><?= _ent($pemohon->email); ?></span>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_nama"><?= _ent($pemohon->pemohon_nama); ?></span>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_jenkel">
							<?php
								if (_ent($pemohon->pemohon_jenkel) == '1') {
									echo 'Laki-Laki';
								}else if (_ent($pemohon->pemohon_jenkel) == '2') {
									echo 'Perempuan';
								}else{
							...
							<div class="form-group ">
								<label for="content" class="col-sm-2 control-label">Alamat Pemohon </label>

								<div class="col-sm-8">
									<span
										class="detail_group-pemohon_alamat"><?= _ent($pemohon->pemohon_alamat); ?></span>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_rt"><?= _ent($pemohon->pemohon_rt); ?></span>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-8">
									<span class="detail_group-pemohon_rw"><?= _ent($pemohon->pemohon_rw); ?></span>
								</div>
							</div>
							...
							<div class="view-nav">
								...
								<a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back'
									title="edit pemohon (Ctrl+e)"
									href="<?= site_url('administrator/pemohon/edit/'.$pemohon->pemohon_id); ?>"><i
										class="fa fa-edit"></i> <?= cclang('update', ['Pemohon']); ?> </a>
								<?php }) ?>
								<a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)"
									href="<?= site_url('administrator/pemohon/'); ?>"><i class="fa fa-undo"></i>
									<?= cclang('go_list_button', ['Pemohon']); ?></a>
							</div>
