               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal form-step" name="form_pemohon" id="form_pemohon" >
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Pemohon Id </label>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">NamaPemohon </label>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                        <span class="detail_group-pemohon_jenkel"><?= _ent($pemohon->pemohon_jenkel); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                        <span class="detail_group-pemohon_alamat"><?= _ent($pemohon->pemohon_alamat); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Pemohon Kode </label>

                        <div class="col-sm-8">
                        <span class="detail_group-pemohon_kode"><?= _ent($pemohon->pemohon_kode); ?></span>
                        </div>
                    </div>
