				...
				<div class="box-body ">
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-pemohon_nama  ">
							<label for="pemohon_nama" class="col-sm-2 control-label">NamaPemohon <i class="required">*</i></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="pemohon_nama" id="pemohon_nama"
									placeholder="" value="<?= set_value('pemohon_nama', $pemohon->pemohon_nama); ?>">
						...
						<div class="form-group ">
							<label for="pemohon_jenkel" class="col-sm-2 control-label">Jenis Kelamin <i
									class="required">*</i>
							</label>
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select" name="pemohon_jenkel"
									id="pemohon_jenkel" data-placeholder="Select Jenis Kelamin">
									<option value=""></option>
									<option <?= $pemohon->pemohon_jenkel == "1" ? 'selected' :''; ?> value="1">Laki-Laki
									</option>
									<option <?= $pemohon->pemohon_jenkel == "2" ? 'selected' :''; ?> value="2">Perempuan
									</option>
								</select>
								<small class="info help-block">
								</small>
						...
						<div class="form-group group-pemohon_alamat  ">
							<label for="pemohon_alamat" class="col-sm-2 control-label">Alamat Pemohon <i
									class="required">*</i>
							</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="pemohon_alamat" id="pemohon_alamat"
									placeholder=""
									value="<?= set_value('pemohon_alamat', $pemohon->pemohon_alamat); ?>">
								<small class="info help-block">
								</small>
							</div>
						</div>
						...
						<div class="form-group group-pemohon_rt  ">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="pemohon_rt" id="pemohon_rt"
									placeholder="" value="<?= set_value('pemohon_rt', $pemohon->pemohon_rt); ?>">
								<small class="info help-block">
									<b>Input Pemohon Rt</b> Max Length : 5.</small>
							</div>
						</div>
						...
						<div class="form-group group-pemohon_rw  ">
							...
							<div class="col-sm-8">
								<input type="number" class="form-control" name="pemohon_rw" id="pemohon_rw"
									placeholder="" value="<?= set_value('pemohon_rw', $pemohon->pemohon_rw); ?>">
								<small class="info help-block">
									<b>Input Pemohon Rw</b> Max Length : 5.</small>
							</div>
						</div>
						...
						<div class="form-group group-kecamatan_id">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="kecamatan_id"
									...
									<option <?= $row->kecamatan_id == $pemohon->kecamatan_id ? 'selected' : ''; ?>
						...
						<div class="form-group group-agama_id">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="agama_id" id="agama_id"
									data-placeholder="Select Agama">
									<option value=""></option>
									<?php
										$conditions = [
											];
									...
									<option <?= $row->agama_id == $pemohon->agama_id ? 'selected' : ''; ?>
										value="<?= $row->agama_id ?>"><?= $row->agama_nama; ?></option>
									<?php endforeach; ?>
								</select>
								<small class="info help-block">
								</small>
