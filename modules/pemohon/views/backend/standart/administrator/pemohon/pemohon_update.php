                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-pemohon_nama  ">
                                <label for="pemohon_nama" class="col-sm-2 control-label">NamaPemohon                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group group-pemohon_alamat  ">
                                <label for="pemohon_alamat" class="col-sm-2 control-label">Alamat Pemohon                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pemohon_alamat" id="pemohon_alamat" placeholder="" value="<?= set_value('pemohon_alamat', $pemohon->pemohon_alamat); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                        ...
                        <div class="form-group group-kecamatan_id">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control chosen chosen-select-deselect" name="kecamatan_id" id="kecamatan_id" data-placeholder="Select Kecamatan">
                                        ...
                                        <option <?= $row->kecamatan_id == $pemohon->kecamatan_id ? 'selected' : ''; ?> value="<?= $row->kecamatan_id ?>"><?= $row->kecamatan_nama; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="info help-block">
                                        </small>
                        ...
                        <div class="form-group group-agama_id">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control chosen chosen-select-deselect" name="agama_id" id="agama_id" data-placeholder="Select Agama">
                                        ...
                                        <option <?= $row->agama_id == $pemohon->agama_id ? 'selected' : ''; ?> value="<?= $row->agama_id ?>"><?= $row->agama_nama; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="info help-block">
                                        </small>
                        ...
                        <div class="form-group group-pemohon_kode  ">
                                <label for="pemohon_kode" class="col-sm-2 control-label">Pemohon Kode                                    </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="pemohon_kode" id="pemohon_kode" placeholder="" value="<?= set_value('pemohon_kode', $pemohon->pemohon_kode); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
