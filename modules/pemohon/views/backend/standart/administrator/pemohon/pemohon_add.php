...
<section class="content">
                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-user_id ">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="user_id" id="user_id" placeholder="User Id" value="<?= set_value('user_id'); ?>">
    ...
    <div class="form-group group-pemohon_nama ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pemohon_nama" id="pemohon_nama" placeholder="NamaPemohon" value="<?= set_value('pemohon_nama'); ?>">
                                <small class="info help-block">
    ...
    <div class="form-group group-pemohon_created_at ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datetimepicker" name="pemohon_created_at" id="pemohon_created_at">
                                </div>
                                <small class="info help-block">
                                    </small>
                            </div>
    ...
    <div class="form-group group-pemohon_kode ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pemohon_kode" id="pemohon_kode" placeholder="Pemohon Kode" value="<?= set_value('pemohon_kode'); ?>">
                                <small class="info help-block">
                                    </small>
                            </div>
                        </div>
