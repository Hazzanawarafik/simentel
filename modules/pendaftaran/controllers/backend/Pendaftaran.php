...
class Pendaftaran extends Admin	
{
	...
	*/
	public function add_save()
	{
		...
		$this->form_validation->set_rules('tempat', 'Tempat', 'trim|required|max_length[100]');
		...
		$this->form_validation->set_rules('no_telepon_kantor', 'No Telepon Kantor', 'trim|required|max_length[12]');
